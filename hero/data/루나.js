var data = [
  {
    ...
    "Fetters": [
      {
        "Condition": "루나를 출전시켜 아레나에서 5회 승리"
      },
      {
        "Condition": "루나를 출전시켜 시공의 균열 3-1[정예] 클리어"
      },
      {
        "Condition": "루인의 도움 받아 '미식의 포로' 클리어"
      },
      {
        "Condition": "디하르트의 도움 받아 '꿈의 식재료' 클리어"
      }
    ],
    ...
    "Jobs": [
      {
        ...
        "SD": [
          {
            "ImageUrl": "루나/1/1.webp"
          },
          {
            "ImageUrl": "루나/2/1.webp"
          },
          {
            "ImageUrl": "루나/3/1.webp"
          },
          {
            "ImageUrl": "루나/4/1.webp"
          },
          {
            "ImageUrl": "루나/5/1.webp"
          },
          {
    ...
    "ClassUp": [
      ...
      {
        "ClassTitle": "페가수스 마스터 : 생명+90, 방어+10, 마방+16",
        "Tiers": [
          {
            "Name": "T1",
            "Materials": [
      ...
      {
        "ClassTitle": "보우마스터 : 생명+150, 공격+15, 마방+10",
        "Tiers": [
          {
            "Name": "T1",
            "Materials": [
    ...
    "Skills": [
      ...
      },
      {
        ...
        "IconImageUrl": "../img/skills/Skill_WindForce.webp",
      ...
      },
      {
        ...
        "Desc": "[지원] 사용시 [고급 바람의 포옹] 획득 : 자신의 '마방'의 1.5배를 '공격'으로 대체한다.<br/>(해당효과는 해제 불가), 지속 6턴<br/>또한 [풍신의 영역] 획득 : 자신 주변 2칸내 이동 방식이 비행이 아닌 다른 아군이 이동시<br/>이동력 소모를 2칸만큼 면제 해준다. 지속 2턴<br/>사용후 3칸 이동가능하며 다시 공격 할 수 있다.",
        "SubSkills": null,
    ...
    "Bio": [
      {
        "Entry": "영웅소개",
        "Desc": "◆키/몸무게：170cm / 49kg<br/>◆신체 사이즈：86/60/87<br/>◆출연：랑그릿사III<br/>◆소속：라카스 왕국"
      },
      {
        "Entry": "영웅담1",
        "Desc": "천재 군사 트랜드 남작의 딸로 똑똑하고 박학다식하기가 아버지에 전혀 뒤처지지 않는다. 군사의 신분이지만 그렇다고 나약한 것도 아닌, 전선에선 얕잡아 볼 수 없는 상대이다.라카스 독립 전쟁에 참여해 군사로서 유례없는 공훈을 세우고 디하르트와 그의 부대를 수차례나 위기에서 구해주었다.<br/><font color=\"#DC143C\"><size=33><i>「해야 할 일을 한 것뿐입니다.」</i>  </size=33></font>"
      },
      {
        "Entry": "영웅담2",
        "Desc": "주의 깊고 빈틈이 없으며 냉정하면서도 강인하다. 전장에선 천재에 걸맞은 통찰력을 발휘한다. 원래 감정이 없는 것처럼 언제나 냉철하고 이성적으로 행동하며 전쟁에 관련된 내용 말고는 이야기를 잘 하지 않는다. 말수가 적고 잘 웃지 않는 탓에 많은 사람들로부터 지나치게 엄숙하다거나 재미없는 사람이라는 평가를 받는다."
      },
      {
        "Entry": "영웅담3",
        "Desc": "대륙 천재 군사의 딸로 태어난 루나는 자연스럽게 아버지로부터 각종 책략과 병법을 배우게 되었다. 온갖 책략으로 제국군을 괴롭혔으며 제국의 「지장」이라 불리는 에마링크마저 루나에겐 패배하였다."
      },
      {
        "Entry": "영웅담4",
        "Desc": "전쟁이 끝난 후 루나는 아버지 트랜드 남작의 곁으로 돌아가지 않고 엘스리드 왕가에 남아 계속 군사의 책무를 이어나갔다. 새로 탄생한 왕국을 지키며, 직접 군을 이끌고 변방의 반란을 진압하기도 하였다. 훗날 겪어온 작전 경험과 병법을 책으로 집필해 후세에 남겼다."
      },
      {
        "Entry": "영웅담5",
        "Desc": "소환된 그녀는 아무 망설임 없이 현세의 전투에 뛰어들었다. 그리고 마치 전장을 떠난 적이 없던 것처럼 사람들을 이끌고 마족에게 반격을 시작하였다.<br/><font color=\"#DC143C\"><size=33><i>「별로 이상한 일은 아니지 않나요?」</i>  </size=33></font>"
      }
    ],
    "Performance": [
      {
        "Entry": "「소환 - 등장대사」",
        "Desc": "호크 나이트의 루나가 왔습니다. 짧은 시간일지도 모르지만 제 창을 당신께 바치겠습니다."
      },
      {
        "Entry": "「전투 - 전직1」",
        "Desc": "이 정도 가지고 뭘 그리 좋아하는 겁니까. ...하지만 연회를 열겠다면 말리진 않겠어요."
      },
      {
        "Entry": "「전투 - 전직2」",
        "Desc": "해냈습니다. 또 새로운 분야에 도전할 수 있습니다. 함께 힘내도록 해요!"
      },
      {
        "Entry": "「전투 - 스킬시전1」",
        "Desc": "각오하세요!"
      ...
      {
        "Entry": "「대화 - 친밀도1」",
        "Desc": "게으름 피우지 마세요. 당신이라 할지라도 봐주지 않겠습니다."
      },
      {
        "Entry": "「대화 - 친밀도2」",
        "Desc": "어서 일어나 주세요. 훈련이 시작됩니다....그리고... 아침 식사도 중요합니다."
      },
      {
        "Entry": "「대화 - 친밀도3」",
        "Desc": "제가 너무 엄격한가요? 죄송합니다. 저는 군사이기 때문에, 군의 전력을 유지하는 것도 제 임무입니다."
      },
      {
        "Entry": "「대화 - 친밀도4」",
        "Desc": "행군 중 구입하는 식료품 목록입니다. ...웃지 마세요! 이건 정말정말 중요한 이야기니까요!"
      },
      {
        "Entry": "「대화 - 친밀도5」",
        "Desc": "다, 당신 언제부터 거기에 있었습니까! 어, 초콜렛을 가지고 왔다고요? ...알겠습니다. 용서해 드릴테니 맛있는 걸 나눠주세요."
      },
      {
        "Entry": "「대화 - 일상1」",
        "Desc": "칼자스 제일의 비병... 모두가 동경하는 존재이지만, 저에게는 그 이름으로 불릴만 한 힘이 있죠."
      },
      {
        "Entry": "「대화 - 기쁨」",
        "Desc": "하늘을 나는 걸 좋아하나요? 당신도 호크 나이트 훈련에 참가하지 않겠습니까? 분명 병사들의 사기도 오를거예요."
      },
      {
        "Entry": "「대화 - 분노」",
        "Desc": "저는 어릴때부터 아버님께 병법을 배웠습니다. 그저 장식뿐인 군사가 아니란 걸 잊지 마세요!"
      },
      {
        "Entry": "「대화 - 슬픔」",
        "Desc": "「천재」라 불리고 있지만.... 그것도 결국 잔혹한 전쟁의 산물일 뿐입니다."
      },
      {
        "Entry": "「대화 - 수줍음」",
        "Desc": "군대는... 연애를 하는 곳이 아닙니다. ...당신, 듣고 계십니까?"
      },
      {
        "Entry": "「상호작용 - 대사1」",
        "Desc": "가끔은...조금...쉬어 볼까요...."
      ...
      {
        "Entry": "「상호작용 - 대사5」",
        "Desc": "저희들... 조금 지나친 것 같네요. 이제와서 하는 말이지만...."
      },
      {
        "Entry": "「상호작용 - 호감1」",
        "Desc": "전혀... 군사라는 지위와는 어울리지 않는군요...."
      },
      {
        "Entry": "「상호작용 - 호감2」",
        "Desc": "멈추지 말아 주세요.... 부끄럽지만 당신이라면 제 마음을 알아 주시겠죠!"
      },
      {
        "Entry": "「상호작용 - 반감1」",
        "Desc": "지휘관님... 이대로 가다간 사기에 영향을 끼칠 수 있습니다!"
      },
      {
        "Entry": "「상호작용 - 반감2」",
        "Desc": "뭐라고?"
      ...
      {
        "Entry": "「상호작용 - 특수1」",
        "Desc": "또 이렇게 즐거운 시간을 보냈네요.... 가끔씩은 전황에 관한 이야기도 해야합니다.... 그렇죠?"
      },
      {
        "Entry": "「상호작용 - 특수2」",
        "Desc": "언제든 싸울 수 있는 준비를 하세요!"
      }
    ],
    "Performance2": null,
    "Misc": ""
