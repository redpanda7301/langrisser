var data = [
{
  ...
  "Fetters": [
    ...
    {
      "Condition": "소피아를 프로핏전직"
    },
    {
      "Condition": "쥬그라의 도움 받아 '어둠 속의 공포' 클리어"
    },
    {
      "Condition": "디하르트의 도움 받아 '아름다운 수호자' 클리어"
    }
  ],
  ...
  "Skills": [
    ...
    },
    {
      ...
      "IconImageUrl": "../img/skills/Skill_ClearCD.webp",
  ...
  "Bio": [
    ...
    {
      "Entry": "영웅담1",
      "Desc": "빛의 대신전 대사제인 현자 파벨의 딸로 고대 결계 '루시리스 게이트'의 수호자 중 한 명이다. 강인하면서도 성녀처럼 부드러운 성품을 지닌 여성. 결계를 지키고 마족의 침입을 감시하는 중책을 맡고 있으며 모든 사람의 행복을 위해 묵묵히 노력한다. 초대 빛의 무녀로서 마검 알하자드를 봉인하는 힘을 갖고 있다. <br/><font color=\"#DC143C\"><size=33><i>「마족이 이곳을 통과하게 둘 수 없어요!」</i>  </size=33></font>"
    },
    {
      "Entry": "영웅담2",
      "Desc": "순결하고 선량한 마음씨를 갖고 있으며 이해심이 많다. 유약해 보이는 외모 아래 용감하고 굳건한 마음을 지니고 있으며 무고한 사람을 해치는 일은 결코 용납하지 않는다.<br/><font color=\"#DC143C\"><size=33><i>「걱정 마세요. 당신의 승리를 위해 제가 언제나 기도하겠습니다! 」</i>  </size=33></font>"
    },
    {
      "Entry": "영웅담3",
    ...
    {
      "Entry": "영웅담5",
      "Desc": "이곳 사람들이 받은 상처에 가슴 아파하며 동료들과 같이 도탄에 빠진 세계를 치료하기 위해 노력한다.<br/><font color=\"#DC143C\"><size=33><i>「순결한 바람이 대륙을 가로질러 갑니다. 여기서 맹세하는데 이 세계의 아름다운 사랑을 지키겠어요...」</i>  </size=33></font>"
    }
  ],
  "Performance": [
    {
