var data = [
{
  ...
  "Fetters": [
    ...
    {
      "Condition": "일레인을 출전시켜 시공의 균열 3-1[정예] 클리어"
    },
    {
      "Condition": "일레인을 검성으로 전직"
    },
    {
      "Condition": "일레인을 소드 메이든으로 전직"
    }
  ],
  ...
  "ClassUp": [
    ...
    {
      "ClassTitle": "소드 메이든 : 공격+25, 생명+90, 방어+10",
      "Tiers": [
        {
          "Name": "T1",
          "Materials": [
