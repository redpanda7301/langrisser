var data = [
{
  ...
  "Bio": [
    ...
    {
      "Entry": "영웅담3",
      "Desc": "의 군단을 모아 어둠을 물리친 엘윈의 전설은 수백 년 동안 음유시인들에 의해 전해져 왔다. 하지만 다소 이상한 점이 있는데 바로 이야기의 끝이 전하는 사람마다 다르다는 것이다.누군가는 그가 어둠의 세력을 쓰러뜨렸다 하고 누군가는 그가 제국의 지도자가 되었다고 말했으며 다른 누군가는 그가 마지막에 모든 적과 친구마저 쓰러뜨리고 고독한 왕이 되었다고 말한다."
    },
    {
      "Entry": "영웅담4",
    ...
    {
      "Entry": "영웅담6 (SP)",
      "Desc": "어느 한 가능성 안에서, 엘윈은 레온과 용호상박의 싸움을 반복한 끝에 계시를 얻었다.<br/> 그것은 새로운 자신과 그 안에 잠든 미지의 힘을 일깨워 함께 나아가는 것이었다.<br/>그 늠름한 자태는 사람들에게 '광룡의 기사'라고 칭송받으며,<br/>세상의 전설과 노래로 남았다.<br/><font color=\"#DC143C\"><size=33><i>「내 가능성이 무한하다면,<br/> 난 영원히 빛을 따르며 스스로를 시험하겠어!」</i>  </size=33></font>"
    }
  ],
  "Performance": [
    {
