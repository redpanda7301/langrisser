var data = [
  {
    ...
    "Bio": [
      ...
      {
        "Entry": "영웅담1",
        "Desc": "칼자스 출신의 소녀로 아직 남아있는 빛의 후예이다. 그 혈통 탓에 하이보레안 제국의 위협을 받아 어린 시절부터 같이 보낸 매튜, 그레니어와 함께 도망 길에 나선다. 그리고 여신의 힘을 받아 빛의 후예로서 성검을 다시 만드는 사명을 짊어지게 된다.시공의 균열을 뛰어넘는 힘을 갖고 있어 대륙에 퍼진 성검의 기억을 통해 옛 시대의 영웅을 소환할 수 있다.<br/><font color=\"#DC143C\"><size=33><i>「내 몸속에는 대단한 힘이 있어. 나를 잘 지켜주라고!」</i>  </size=33></font>"
      },
      {
        "Entry": "영웅담2",
      ...
      {
        "Entry": "영웅담3",
        "Desc": "모험을 시작했을 당시에는 드디어 무미건조한 시골 생활에서 벗어나 낯설고 다채로운 바깥 세계로 떠날 수 있어서 기쁘기까지 했다. 하지만 현실의 잔혹함을 마주한 그녀의 생각은 빠르게 바뀌었다. 어둠의 위협이 점차 다가오고 주저할 때마다 무고한 사람이 희생되었다. 이제 아멜다는 평온한 생활로 다시 돌아갈 수 없음을 깨닫게 되었다. <br/><font color=\"#DC143C\"><size=33><i>「칼자스의 숲에서 보냈던 아무 걱정 없던 소년 시절로는 다시 돌아갈 수 없겠지...」</i>  </size=33></font>"
      },
      {
        "Entry": "영웅담4",
